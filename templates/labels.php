      ...
      <tr>
        ...
        <td>
          ...
          <ul class="list-inline">
            <li>
              <a onclick="return confirm('<?php echo $this->text('Creating labels is a paid feature unless you operate in test mode. Please confirm'); ?>');" href="<?php echo $this->url('', array('get_label' => $order['data']['shippo']['object_id'], 'order_id' => $id)); ?>">
